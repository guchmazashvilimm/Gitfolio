...
const Data = () =>{
    return (
        ...
        <div className='home__data'>
            <h1 className='home__title'>Mariam Guchmazashvili
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className='home__description'>
              Greetings from self-motivated,hard working and honest individual.
              my interests are in front end engineering and i love to create
               an appealing products with delightful user experiences.
               I am willing to learn new skills and have interesting existing ones to offer.
               I would like to tell you more about myself below.
            </p>
